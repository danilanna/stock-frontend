...
import {deleteClient, openCloseDialog, openCloseAlert} from "../../redux/actions/clientActions";
...
function Clients(props) {
    ...
    function callbackDialogYes() {
        ...
        props.deleteClient({id: data.id, name: data.name});
    ...
    return (
        <div>
            ...
            <MaterialTable
                ...
                data={query => ClientApi.getAllClients(query)
                    .catch(() => {
                        const error = {
...
function mapStateToProps(state) {
    const {isFetching, removed, openDialog, dialogData} = state.clientReducer;
    return {
        isFetching,
        removed,
        openDialog,
